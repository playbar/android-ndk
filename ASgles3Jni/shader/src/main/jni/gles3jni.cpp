...
extern "C" {
    JNIEXPORT void JNICALL Java_com_android_jni_GLES3JNILib_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_com_android_jni_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height);
    JNIEXPORT void JNICALL Java_com_android_jni_GLES3JNILib_step(JNIEnv* env, jobject obj);
};
